...
> 本文以RocketMQ为例进行讲解，转载自[面渣逆袭：RocketMQ二十三问](https://mp.weixin.qq.com/s?__biz=MzkwODE5ODM0Ng==&mid=2247490996&idx=1&sn=ba9558574d71979aa689a710c28c7e0e&scene=21#wechat_redirect)
...
![消息队列解耦](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-dd332b3f-d5e5-41bc-813a-9f612e582255.jpg)


*   **异步**：订单支付之后，我们要扣减库存、增加积分、发送消息等等，这样一来这个链路就长了，链路一长，响应时间就变长了。引入消息队列，除了`更新订单状态`，其它的都可以**异步**去做，这样一来就来，就能降低响应时间。

![消息队列异步](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-40d8f782-08cf-48c4-98b2-cb125d287e93.jpg)
...
![消息队列削峰](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-f028cb0c-b1a3-47ef-b290-f7d6f46512fb.jpg)
...
![四大消息队列对比](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-c3493e70-67c7-4f0d-bb99-f0fe8074c807.jpg)
...
![队列模型](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-d94a9bf9-3fed-40a6-8aef-0d0395b6e409.jpg)
...
![发布-订阅模型](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-692ec6a0-8499-4de2-be17-a577996bdaef.jpg)
...
![RocketMQ消息的组成](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-4ab7f942-23d7-4462-8e36-e305cc0a045f.jpg)
...
![](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-e470b972-f4ac-4b76-bcde-0df5d4765ca7.jpg)

### 6.消息的消费模式了解吗？

消息消费模式有两种：**Clustering**（集群消费）和**Broadcasting**（广播消费）。

![两种消费模式](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-2c574635-1eaa-4bdd-8aa8-1bdc3f10b274.jpg)
...
![RocketMQ架构](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-d4c0e036-0f0e-466f-bd4b-7e6ee10daca4.jpg)
...
![RocketMQ类比邮政体系](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-00175355-5532-4ee6-a48c-e3e3a9b87d64.jpg)
...
![RocketMQ存储-图片来源官网](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-789379a9-4a0c-4992-9de1-e49283d089a4.jpg)
...
![消息传递三阶段](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-692a920d-621f-4b36-87f8-edb53e7f5cd9.jpg)
...
![同步刷盘和异步刷盘-图片来源官网](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-61a3b092-1329-4738-bef9-6eb7ae429c26.jpg)
...
![消息重复处理](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-05c0538b-abfa-4bb0-973f-6b92555a6e5b.jpg)
...
![消息积压处理](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-5d1ea064-1a37-4746-ad26-a18a1c8c344e.jpg)
...
![消息迁移扩容消费](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-69aa8004-45e9-4e41-b628-1d7ed6d94c92.jpg)
...
![顺序消息](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-e3de6bb5-b5db-47af-8ae3-73aedd269f32.jpg)
...
![部分顺序消息](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-14ab3700-8538-473e-bb66-8acfdd6a77a2.jpg)



发送端使用 MessageQueueSelector 类来控制 把消息发往哪个 Message Queue 。

![顺序消息生产-例子来源官方](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-4aad853e-4dd7-4cde-b28d-b6e74ca9331f.jpg)



消费端通过使用 MessageListenerOrderly 来解决单 Message Queue 的消息被并发处理的问题。

![](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-f233ab8e-87f0-4b64-91eb-d4d9ec71ab3e.jpg)
...
![全局顺序消息](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-8e98ac61-ad47-4ed4-aac6-223201f9aae2.jpg)
...
![消息过滤](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-f2c8bf50-dc51-44c8-9d71-b8a22af199c4.jpg)
...
![延迟消息处理流程-图片来源见水印](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-e3b68480-8006-4cd6-892a-1c72f8b0fbcb.jpg)
...
![RocketMQ实现消息事务](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-76df2fb9-0f3f-496d-88a8-aac79ad1102c.jpg)
...
![NameServer集群](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-0ce789f4-7a47-4c24-ac08-76f0490298f7.jpg)



RocketMQ的高可用主要是在体现在Broker的读和写的高可用，Broker的高可用是通过`集群`和`主从`实现的。

![Broker集群、主从示意图](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-76c5eb61-9605-4620-84fb-dc960f01de85.jpg)
...
![RocketMQ整体工作流程](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-ec571bd4-fa24-4ada-87ab-f761a7dfdf3f.jpg)
...
![](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-b6d13d4d-c417-43b4-bfe1-12724777888c.jpg)

消息存储的整体的设计：

![消息存储整体设计-来源官网](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-ddbf8773-1d71-4d1a-a186-46f6985b621e.jpg)
...
![CommitLog](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-a76f7365-8a8c-4b91-9505-9d427cf3bde4.jpg)
...
![Comsumer Queue](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-c8b22760-35c2-436b-81ed-be49a107357b.jpg)
...
![IndexFile文件示意图](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-f06f306b-fd87-48ff-b1cb-e39750d308e7.jpg)
...
![](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-80af9918-2d4b-4b43-b83a-d44bfc0f30bc.jpg)
...
![传统文件传输示意图-来源《图解操作系统》](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-35fd884c-8d1b-4d04-8f09-23ed2f945b23.jpg)
...
![mmap示意图-来源《图解操作系统》](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-3ebab020-e411-4239-b91e-72147190c7b1.jpg)
...
![异步刷盘](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-10a2361b-5e23-462f-86bf-1a9bce2342e5.jpg)
...
![](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-5f254411-502b-4bd3-89b5-d3157964617b.jpg)
...
![](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-7cbfd097-5186-47ba-9641-687bc9381d0b.jpg)
...
![Cosumer分配](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-6d1c69e7-5245-495f-8f8d-b5e48162df6f.jpg)



(4) 然后，调用updateProcessQueueTableInRebalance()方法，具体的做法是，先将分配到的消息队列集合（mqSet）与processQueueTable做一个过滤比对。

![](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-c84236ed-77a6-45e9-b086-4927d72ce21a.jpg)
...
![长轮询简单示意图](https://upyun.xuqiming.tech/knhub/weixin-mianznxrocketmqessw-5a715dea-8e18-471e-9a74-e97299901658.jpg)
