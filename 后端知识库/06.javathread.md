...
![线程常用调度方法](https://upyun.xuqiming.tech/knhub/javathread-6.png)
...
![ScheduledThreadPool执行流程](https://upyun.xuqiming.tech/knhub/javathread-75.png)
...
![JDK 线程池参数设置接口来源参考[7]](https://upyun.xuqiming.tech/knhub/javathread-79.png)

这里主要有两个思路：

![动态修改线程池参数](https://upyun.xuqiming.tech/knhub/javathread-80.png)
...
![线程池评估方案 来源参考[7]](https://upyun.xuqiming.tech/knhub/javathread-81.png)
...
![线程池调优](https://upyun.xuqiming.tech/knhub/javathread-82.png)
...
![线程池主要实现流程](https://upyun.xuqiming.tech/knhub/javathread-83.png)
...
![自定义线程池](https://upyun.xuqiming.tech/knhub/javathread-84.png)
...
关于一些并发容器，可以去看看 [Java集合连环三十问  ](https://mp.weixin.qq.com/s/SHkQ7LEOT0itt4bXMoDBPw)，里面有`CopyOnWriteList`和`ConcurrentHashMap`这两种线程安全容器类的问答。。
...
![Fork/Join分治算法](https://upyun.xuqiming.tech/knhub/javathread-85.png)
...
![工作窃取](https://upyun.xuqiming.tech/knhub/javathread-86.png)
