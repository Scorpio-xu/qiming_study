...
![下辈子还学Java](https://upyun.xuqiming.tech/knhub/javase-1.png)
...
![Java语言特点](https://upyun.xuqiming.tech/knhub/javase-2.png)
...
![JDK、JRE、JVM关系](https://upyun.xuqiming.tech/knhub/javase-3.png)
...
![Java程序执行过程](https://upyun.xuqiming.tech/knhub/javase-4.png)
...
![编译与解释](https://upyun.xuqiming.tech/knhub/javase-5.png)
...
![Java数据类型](https://upyun.xuqiming.tech/knhub/javase-6.png)
...
![Java自动类型转换方向](https://upyun.xuqiming.tech/knhub/javase-7.png)
...
![装箱和拆箱](https://upyun.xuqiming.tech/knhub/javase-8.png)
...
![break 、continue 、return](https://upyun.xuqiming.tech/knhub/javase-9.png)
...
![面向对象和面向过程的区别](https://upyun.xuqiming.tech/knhub/javase-10.png)

### 16.面向对象有哪些特性

![面向对象三大特征](https://upyun.xuqiming.tech/knhub/javase-11.png)
...
![访问修饰符和可见性](https://upyun.xuqiming.tech/knhub/javase-12.png)
...
![final修饰变量](https://upyun.xuqiming.tech/knhub/javase-13.png)
...
![Java引用数据值传递示意图](https://upyun.xuqiming.tech/knhub/javase-14.png)
...
![浅拷贝和深拷贝示意图](https://upyun.xuqiming.tech/knhub/javase-15.png)
...
![Java创建对象的四种方式](https://upyun.xuqiming.tech/knhub/javase-16.png)
...
![堆与常量池中的String](https://upyun.xuqiming.tech/knhub/javase-17.png)
...
![jdk1.8之前的字符串拼接](https://upyun.xuqiming.tech/knhub/javase-18.png)
...
![Integer.valueOf](https://upyun.xuqiming.tech/knhub/javase-19.png)
...
![parseInt示意图](https://upyun.xuqiming.tech/knhub/javase-20.png)
...
![Object类的方法](https://upyun.xuqiming.tech/knhub/javase-21.png)
...
![Java异常体系](https://upyun.xuqiming.tech/knhub/javase-22.png)
...
![异常处理](https://upyun.xuqiming.tech/knhub/javase-23.png)
...
![IO-操作方式分类-图片来源参考[2]](https://upyun.xuqiming.tech/knhub/javase-24.jpeg)
...
![Java IO流用到装饰器模式](https://upyun.xuqiming.tech/knhub/javase-25.png)
...
![BIO、NIO、AIO](https://upyun.xuqiming.tech/knhub/javase-26.png)
...
![BIO、NIO、AIO](https://upyun.xuqiming.tech/knhub/javase-27.png)
...
![NIO线程](https://upyun.xuqiming.tech/knhub/javase-28.png)

NIO 的数据是面向**缓冲区 Buffer**的，必须从 Buffer 中读取或写入。

所以完整的 NIO 示意图：

![NIO完整示意图](https://upyun.xuqiming.tech/knhub/javase-29.png)
...
![序列化和反序列化](https://upyun.xuqiming.tech/knhub/javase-30.png)
...
![Java常见序列化方式](https://upyun.xuqiming.tech/knhub/javase-31.png)
...
![泛型类、泛型接口、泛型方法](https://upyun.xuqiming.tech/knhub/javase-32.png)
...
![Java注解和帽子](https://upyun.xuqiming.tech/knhub/javase-33.png)
...
![Override注解](https://upyun.xuqiming.tech/knhub/javase-34.png)
...
![Autowired注解](https://upyun.xuqiming.tech/knhub/javase-35.png)
...
![Java反射相关类](https://upyun.xuqiming.tech/knhub/javase-36.png)
...
![JDK1.8主要新特性](https://upyun.xuqiming.tech/knhub/javase-37.png)
...
![Java Stream流](https://upyun.xuqiming.tech/knhub/javase-38.png)
