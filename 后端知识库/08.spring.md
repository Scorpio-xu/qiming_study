...
![Spring Logo](https://upyun.xuqiming.tech/knhub/spring-165c27b4-2ea0-409a-8fa5-389c105db0fa.png)
...
![Spring重要版本](https://upyun.xuqiming.tech/knhub/spring-5d9efb93-03a5-400c-8429-3be7c5eeddfb.png)
...
![Spring特性](https://upyun.xuqiming.tech/knhub/spring-a0f0ef9d-3289-41ea-94c2-34b7e37ef854.png)
...
![Spring模块划分](https://upyun.xuqiming.tech/knhub/spring-bb7c13ea-3174-4b32-84b8-821849ddc377.png)
...
![Spring常用注解](https://upyun.xuqiming.tech/knhub/spring-8d0a1518-a425-4887-9735-45321095d927.png)
...
![Spring中用到的设计模式](https://upyun.xuqiming.tech/knhub/spring-ee1c5cee-8462-4bae-93ea-ec936cc77640.png)
...
![引入IOC之前和引入IOC之后](https://upyun.xuqiming.tech/knhub/spring-619da277-c15e-4dd7-9f2b-dbd809a9aaa0.png)

也就是说，控制对象生命周期的不再是引用它的对象，而是容器。对具体对象，以前是它控制其它对象，现在所有对象都被容器控制，所以这就叫**控制反转**。

![控制反转示意图](https://upyun.xuqiming.tech/knhub/spring-440f5d0e-f4db-462c-97fb-d54407a354d5.png)
...
![工厂运行](https://upyun.xuqiming.tech/knhub/spring-7678c40f-a48d-4bd5-80f8-e902ad688e11.png)
...
![mini版本Spring IOC](https://upyun.xuqiming.tech/knhub/spring-1d55c63d-2d12-43b1-9f43-428f5f4a1413.png)
...
![BeanFactory](https://upyun.xuqiming.tech/knhub/spring-c6b3b707-cf53-4c7c-a6f9-8560950806fc.png)
...
![BeanFactory和ApplicantContext的比喻](https://upyun.xuqiming.tech/knhub/spring-66328446-f89f-4b7a-8d9f-0e1145dd9b2f.png)
...
![Spring5 BeanFactory继承体系](https://upyun.xuqiming.tech/knhub/spring-6e6d4b69-f36c-41e6-b8ba-9277be147c9b.png)
...
![Spring5 ApplicationContext部分体系类图](https://upyun.xuqiming.tech/knhub/spring-e201c9a3-f23c-4768-b844-ac7e0ba4bcec.png)
...
![容器启动和Bean实例化阶段](https://upyun.xuqiming.tech/knhub/spring-8f8103f7-2a51-4858-856e-96a4ac400d76.png)
...
![xml配置信息映射注册过程](https://upyun.xuqiming.tech/knhub/spring-dfb3d8c4-ba8d-4a2c-aef2-4ad425f7180c.png)
...
![Bean生命周期四个阶段](https://upyun.xuqiming.tech/knhub/spring-595fce5b-36cb-4dcb-b08c-8205a1e98d8a.png)
...
![SpringBean生命周期](https://upyun.xuqiming.tech/knhub/spring-942a927a-86e4-4a01-8f52-9addd89642ff.png)

简单总结一下，Bean 生命周期里初始化的过程相对步骤会多一些，比如前置、后置的处理。

最后通过一个实例来看一下具体的细节：
![Bean一生实例](https://upyun.xuqiming.tech/knhub/spring-a3b7714e-38f2-433d-97c6-acb1d20f2887.png)
...
![Bean生命周期源码追踪](https://upyun.xuqiming.tech/knhub/spring-d2da20a3-08d0-4648-b9a3-2fff8512b159.png)

### 10.Bean 定义和依赖定义有哪些方式？

有三种方式：**直接编码方式**、**配置文件方式**、**注解方式**。

![Bean依赖配置方式](https://upyun.xuqiming.tech/knhub/spring-89f0f50d-a9e4-4dec-b267-cb1a526cb340.png)
...
![Spring依赖注入方法](https://upyun.xuqiming.tech/knhub/spring-491f8444-54ba-4628-b8eb-8418a2197096.png)
...
![Spring四种自动装配类型](https://upyun.xuqiming.tech/knhub/spring-034120d9-88c7-490b-af07-7d48f3b6b7bc.png)
...
![Spring Bean支持作用域](https://upyun.xuqiming.tech/knhub/spring-08a9cb31-5a4f-4224-94cd-0c0f643a57ea.png)
...
![Spring单例Bean线程安全问题](https://upyun.xuqiming.tech/knhub/spring-35dacef4-1a9e-45e1-b3f2-5a91227eb244.png)
...
![Spring循环依赖](https://upyun.xuqiming.tech/knhub/spring-f8fea53f-56fa-4cca-9199-ec7f648da625.png)

Spring 循环依赖：简单说就是自己依赖自己，或者和别的 Bean 相互依赖。

![鸡和蛋](https://upyun.xuqiming.tech/knhub/spring-0035fd25-2972-4642-a8ec-ee44a566a5bd.png)
...
![循环依赖的几种情形](https://upyun.xuqiming.tech/knhub/spring-37bb576d-b4af-42ed-91f4-d846ceb012b6.png)
...
![Bean初始化步骤](https://upyun.xuqiming.tech/knhub/spring-867066f1-49d1-4e57-94f9-4c66a3a8797e.png)
...
![三级缓存](https://upyun.xuqiming.tech/knhub/spring-01d92863-a2cb-4f61-8d8d-30ecf0279b28.png)

我们来看一下三级缓存解决循环依赖的过程：

当 A、B 两个类发生循环依赖时：
![循环依赖](https://upyun.xuqiming.tech/knhub/spring-cfc09f84-f8e1-4702-80b6-d115843e81fe.png)

A 实例的初始化过程：

1. 创建 A 实例，实例化的时候把 A 对象⼯⼚放⼊三级缓存，表示 A 开始实例化了，虽然我这个对象还不完整，但是先曝光出来让大家知道

![1](https://upyun.xuqiming.tech/knhub/spring-1a8bdc29-ff43-4ff4-9b61-3eedd9da59b3.png)
...
![2](https://upyun.xuqiming.tech/knhub/spring-bf2507bf-96aa-4b88-a58b-7ec41d11bc70.png)

4. 接着 A 继续属性赋值，顺利从⼀级缓存拿到实例化且初始化完成的 B 对象，A 对象创建也完成，删除⼆级缓存中的 A，同时把 A 放⼊⼀级缓存

5. 最后，⼀级缓存中保存着实例化、初始化都完成的 A、B 对象

![5](https://upyun.xuqiming.tech/knhub/spring-022f7cb9-2c83-4fe9-b252-b02bd0fb2435.png)
...
![二级缓存不行的原因](https://upyun.xuqiming.tech/knhub/spring-6ece8a46-25b1-459b-8cfa-19fc696dd7d6.png)
...
![横向抽取](https://upyun.xuqiming.tech/knhub/spring-09dbcda4-7c1b-42d6-8520-1a5fc84abbde.png)

具体来说，假如我现在要 crud 写一堆业务，可是如何业务代码前后前后进行打印日志和参数的校验呢？

我们可以把`日志记录`和`数据校验`可重用的功能模块分离出来，然后在程序的执行的合适的地方动态地植入这些代码并执行。这样就简化了代码的书写。

![AOP应用示例](https://upyun.xuqiming.tech/knhub/spring-4754b4c0-0356-4077-a2f9-55e246cf8ba0.png)
...
![Java语言执行过程](https://upyun.xuqiming.tech/knhub/spring-2b9859e5-019c-4e87-a449-990d3deae135.png)
...
![环绕方式](https://upyun.xuqiming.tech/knhub/spring-320fa34f-6620-419c-b17a-4f516a83caeb.png)
...
![执行结果](https://upyun.xuqiming.tech/knhub/spring-9c14f774-44b9-41b3-a8c0-f2a54385f6ff.png)
...
![用户向客服提问题](https://upyun.xuqiming.tech/knhub/spring-c5c4b247-62dd-43a2-a043-da51c58f77c8.png)

**JDK 动态代理实现：**

![JDK动态代理类图](https://upyun.xuqiming.tech/knhub/spring-65b14a3f-2653-463e-af77-a8875d3d635c.png)
...
![Cglib动态代理类图](https://upyun.xuqiming.tech/knhub/spring-74da87af-20d1-4a5b-a212-3837a15f0bab.png)
...
![Spring AOP和AspectJ对比](https://upyun.xuqiming.tech/knhub/spring-d1dbe9d9-c55f-4293-8622-d9759064d613.png)
...
![Spring事务分类](https://upyun.xuqiming.tech/knhub/spring-d3ee77fa-926d-4c39-91f8-a8b1544a9134.png)
...
![7种事务传播机制](https://upyun.xuqiming.tech/knhub/spring-a6e2a8dc-9771-4d8b-9d91-76ddee98af1a.png)
...
![图片来源网易技术专栏](https://upyun.xuqiming.tech/knhub/spring-97493c7f-c596-4e98-a6a8-dab254d6d1ab.png)
...
![声明式事务的几种失效的情况](https://upyun.xuqiming.tech/knhub/spring-381e4ec9-a235-4cfa-9b4d-518095a7502a.png)
...
![Spring默认支持的异常回滚](https://upyun.xuqiming.tech/knhub/spring-04053b02-3264-4d7f-b868-560a0333f08d.png)
...
![Spring MVC的工作流程](https://upyun.xuqiming.tech/knhub/spring-e29a122b-db07-48b8-8289-7251032e87a1.png)
...
![Spring MVC Restful请求响应示意图](https://upyun.xuqiming.tech/knhub/spring-2da963a0-5da9-4b3a-aafd-fd8dbc7e1807.png)
...
![SpringBoot图标](https://upyun.xuqiming.tech/knhub/spring-d9164ee6-5c86-4313-8fd9-efb9acfa5f0b.png)
...
![SpringBoot自动配置原理](https://upyun.xuqiming.tech/knhub/spring-df77ee15-2ff0-4ec7-8e65-e4ebb8ba88f1.png)
...
![运行结果](https://upyun.xuqiming.tech/knhub/spring-3ff3cc21-6a56-434b-a89e-d2b55d558bd6.png)
...
![SpringBoot 启动大致流程-图片来源网络](https://upyun.xuqiming.tech/knhub/spring-68744556-a1ba-4e1f-a092-1582875f0da6.png)
...
![Spring Cloud Netfilx核心组件-来源参考[2]](https://upyun.xuqiming.tech/knhub/spring-92ab53d5-f303-4fc5-bd26-e62cefe374b3.png)
...
![SpringCloud](https://upyun.xuqiming.tech/knhub/spring-2b988a72-0739-4fed-b271-eaf12589444f.png)
