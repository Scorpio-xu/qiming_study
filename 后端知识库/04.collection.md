...
![Java集合主要关系](https://upyun.xuqiming.tech/knhub/collection-1.png)
...
![ArrayList和LinkedList的数据结构](https://upyun.xuqiming.tech/knhub/collection-2.png)
...
![ArrayList和LinkedList中间插入](https://upyun.xuqiming.tech/knhub/collection-3.png)

![ArrayList和LinkedList中间删除](https://upyun.xuqiming.tech/knhub/collection-4.png)
...
![ArrayList扩容](https://upyun.xuqiming.tech/knhub/collection-5.png)
...
![ArrayList自定义序列化](https://upyun.xuqiming.tech/knhub/collection-6.png)
...
![CopyOnWriteArrayList原理](https://upyun.xuqiming.tech/knhub/collection-7.png)
...
![jdk1.8 hashmap数据结构示意图](https://upyun.xuqiming.tech/knhub/collection-8.png)
...
![红黑树](https://upyun.xuqiming.tech/knhub/collection-9.png)
...
![左旋](https://upyun.xuqiming.tech/knhub/collection-10.png)

![右旋](https://upyun.xuqiming.tech/knhub/collection-11.png)

- 染⾊：

![染色](https://upyun.xuqiming.tech/knhub/collection-12.png)

### 11.HashMap的put流程知道吗？

先上个流程图吧:

![HashMap插入数据流程图](https://upyun.xuqiming.tech/knhub/collection-13.jpg)
...
![HashMap查找流程图](https://upyun.xuqiming.tech/knhub/collection-14.png)
...
![哈希&运算](https://upyun.xuqiming.tech/knhub/collection-15.png)
...
![扰动函数示意图](https://upyun.xuqiming.tech/knhub/collection-16.jpg)
...
![put中的扩容](https://upyun.xuqiming.tech/knhub/collection-17.png)
...
![容量计算](https://upyun.xuqiming.tech/knhub/collection-18.png)
...
![散列函数构造](https://upyun.xuqiming.tech/knhub/collection-19.png)
...
![开放定址法](https://upyun.xuqiming.tech/knhub/collection-20.png)
...
![源码注释](https://upyun.xuqiming.tech/knhub/collection-21.png)
...
![关于默认负载因子的注释](https://upyun.xuqiming.tech/knhub/collection-24.png)
...
![扩容之后的索引计算](https://upyun.xuqiming.tech/knhub/collection-25.png)

元素在重新计算hash之后，因为n变为2倍，那么n-1的mask范围在高位多1bit(红色)，因此新的index就会发生这样的变化：

![扩容位置变化](https://upyun.xuqiming.tech/knhub/collection-26.png)

所以在扩容时，只需要看原来的hash值新增的那一位是0还是1就行了，是0的话索引没变，是1的化变成`原索引+oldCap`，看看如16扩容为32的示意图：

![扩容节点迁移示意图](https://upyun.xuqiming.tech/knhub/collection-27.png)

扩容节点迁移主要逻辑：

![扩容主要逻辑](https://upyun.xuqiming.tech/knhub/collection-28.png)
...
![自定义HashMap整体结构](https://upyun.xuqiming.tech/knhub/collection-29.png)

完整代码：

![完整代码](https://upyun.xuqiming.tech/knhub/collection-30.png)
...
![1.7ConcurrentHashMap示意图](https://upyun.xuqiming.tech/knhub/collection-31.png)
...
![ConcurrentHashmap jdk1.8put流程](https://upyun.xuqiming.tech/knhub/collection-32.jpg)
...
![Entry节点](https://upyun.xuqiming.tech/knhub/collection-33.png)

可以实现按插入的顺序或访问顺序排序。

![LinkedHashMap实现原理](https://upyun.xuqiming.tech/knhub/collection-34.png)
...
![TreeMap](https://upyun.xuqiming.tech/knhub/collection-35.png)
...
![HashSet套娃](https://upyun.xuqiming.tech/knhub/collection-36.png)
