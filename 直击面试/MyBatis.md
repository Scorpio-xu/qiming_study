...
![mapper传递多个参数方法](../_img/mapper传递多个参数方法.png)
...
![MyBatis批量操作](../_img/MyBatis批量操作.png)
...
![MyBatis功能架构](../_img/MyBatis功能架构.png)
...
![MyBatis插件原理简图](../_img/MyBatis插件原理简图.png)
...
![Mybatis-通用分页拦截器](../_img/Mybatis-通用分页拦截器.png)
