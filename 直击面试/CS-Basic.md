...
> 此部分转载自https://mp.weixin.qq.com/s/KMGyn-FLkvzsMH06LV4OfQ
...
![操作系统是什么](https://img-blog.csdnimg.cn/img_convert/97952a0918b7d902f36cc9d758edecd6.png)
...
![操作系统主要功能](https://img-blog.csdnimg.cn/img_convert/42b7c4d254c6cc1ceca32eb04eb02a68.png)
...
![用户态&内核态切换](https://img-blog.csdnimg.cn/img_convert/a8226a031389184ada7c93f95ef2dbe4.png)
...
![并发和并行](https://img-blog.csdnimg.cn/img_convert/5237a8585c2927f38a974cc7133e50aa.png)
...
![进程上下文切换-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/7f7cdccd843118e5012d18730fbdc348.png)
...
![进程3种状态](https://img-blog.csdnimg.cn/img_convert/6cacd735c1b7b39ef0e83e6ae600549a.png)
...
![进程5种状态](https://img-blog.csdnimg.cn/img_convert/f9d4cb12d5554cfbd85bff525fd62267.png)
...
![进程调度算法](https://img-blog.csdnimg.cn/img_convert/a698ac857cd27bb1336674f9448aa10b.png)
...
![先来先服务](https://img-blog.csdnimg.cn/img_convert/85d6164d388a54f4681fabf4d1722cb6.png)

- **短作业优先**

非抢占式的调度算法，按估计运行时间最短的顺序进行调度。长作业有可能会饿死，处于一直等待短作业执行完毕的状态。因为如果一直有短作业到来，那么长作业永远得不到调度。

![短作业优先](https://img-blog.csdnimg.cn/img_convert/7060888fd2ec6201b0792989f9d51149.png)

- **优先级调度**

为每个进程分配一个优先级，按优先级进行调度。为了防止低优先级的进程永远等不到调度，可以随着时间的推移增加等待进程的优先级。

![优先级调度](https://img-blog.csdnimg.cn/img_convert/99a444e9742ceb4786d580ec49441461.png)
...
![时间片轮转](https://img-blog.csdnimg.cn/img_convert/dd919e15cd221f29f88b93b4b1d958d1.png)
...
![进程间通信方式](https://img-blog.csdnimg.cn/img_convert/09ad6c3c0f09009bd39cb0fd63209a54.png)
...
- 管道：管道可以理解成不同进程之间的对白，一方发声，一方接收，声音的介质可是是空气或者电缆，进程之间就可以通过管道，**所谓的管道就是内核中的一串缓存**，从管道的一端写入数据，就是缓存在了内核里，另一端读取，也是从内核中读取这段数据。
  ...
  ![“奉先我儿”](https://img-blog.csdnimg.cn/img_convert/c3eca23aedb76d7490b4cb6bc4543a49.png)
...
![消息队列](https://img-blog.csdnimg.cn/img_convert/6d5e8825fd7b22f291cd6b262d7274d7.png)
...
![共享内存](https://img-blog.csdnimg.cn/img_convert/6670ae4dffde52e61380d996401b7f13.png)
...
- 信号量：信号量我们可以理解成红绿灯，红灯行，绿灯停。**它本质上是一个整数计数器**，可以用来控制多个进程对共享资源的访问。它常作为一种锁机制，防止某进程正在访问共享资源时，其他进程也访问该资源。因此，主要作为进程间以及同一进程内不同线程之间的同步手段。
  ...
  ![信号量](https://img-blog.csdnimg.cn/img_convert/1645aad39942bd5e2acc54090758078b.png)
...
![多线程-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/22c74c61920548c1448675e00f1b3346.png)
...
![内核态线程实现](https://img-blog.csdnimg.cn/img_convert/17c90646417d7f5773648dbaa59d2a93.png)

- **⽤户态线程实现**：在⽤户空间实现线程，不需要内核的参与，内核对线程无感知。

![用户态线程](https://img-blog.csdnimg.cn/img_convert/1dbb1dd5ed74aa692fd41b791036b8fd.png)
...
![混合线程实现](https://img-blog.csdnimg.cn/img_convert/bdb57bbc796826255aa5adc1b1243086.png)
...
![临界区互斥-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/3b2df067c651fa869b222ff45e4daa99.png)
...
![加锁和解锁-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/6ad4756580bfd4095e8d962f246601c1.png)
...
![死锁](https://img-blog.csdnimg.cn/img_convert/33b810d8e9ede46f9461a37b1accd51c.png)
...
每个进程都有自己独立的[地址空间](https://so.csdn.net/so/search?q=地址空间&spm=1001.2101.3001.7020)，再由操作系统映射到到实际的物理内存。
...
![虚拟内存](https://img-blog.csdnimg.cn/img_convert/8f5278a3e2e5a88bcca81806c55b5b94.png)
...
![虚拟地址、段表、物理地址](https://img-blog.csdnimg.cn/img_convert/d048829783d87b77ced6d11aebd570d7.png)

我们来看一个映射，虚拟地址：段3、段偏移量500 ----> 段基地址7000+段偏移量500 ----> 物理地址：7500。

![段虚拟地址映射](https://img-blog.csdnimg.cn/img_convert/8c2ee0eb94d9c176acd5f31b7b8d4624.png)
...
![内存分页](https://img-blog.csdnimg.cn/img_convert/b1afd7f49e64e99a1ff26fe4a43c26aa.png)
...
![多级页表示意图](https://img-blog.csdnimg.cn/img_convert/4d0785e1af222a5b4c5a70a921889aa0.png)
...
![TLB示意图-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/018e607725b23376d8801e9d41688d6f.png)
...
![常见页面置换算法](https://img-blog.csdnimg.cn/img_convert/acb35cb3b918d361a99a0f9a0aff5792.png)
...
![按照进入内存早晚构建的页面链表 ](https://img-blog.csdnimg.cn/img_convert/86d1724ca6f396a2fa53a83b326f4198.png)
...
![LRU实现](https://img-blog.csdnimg.cn/img_convert/f7680a7d0ca5baa33f5c2be8ea61f31c.png)
...
![时钟页面置换算法](https://img-blog.csdnimg.cn/img_convert/68a700193f3d3fbff6815c60cf90c22c.png)
...
![硬链接-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/51a91cf42c40e1a2e2cad380656a7ad6.png)
...
- 软链接相当于重新创建⼀个⽂件，这个⽂件有**独⽴的** **inode**，但是这个**⽂件的内容是另外⼀个⽂件的路径**，所以访问软链接的时候，实际上相当于访问到了另外⼀个⽂件，所以**软链接是可以跨⽂件系统的**，甚⾄**⽬标⽂件被删除了，链接⽂件还是在的，只不过打不开指向的文件了而已。**
  ...
  ![软链接-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/9a6e881c3e1bcc3493f10f3e6dee1ad1.png)
...
![传统文件传输示意图-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/23bb4dbff1a9f9f32d5dea32f58df8e8.png)
...
![mmap示意图-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/9fbc3c199772ad9464a58fd0cf269049.png)
...
![sendfile示意图-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/49d086f09843826ed7238373ae732dae.png)

很多开源项目如Kafka、RocketMQ都采用了零拷贝技术来提升IO效率。

### 31.聊聊**阻塞与⾮阻塞** **I/O **、 **同步与异步** **I/O**？
...
![阻塞I/O](https://img-blog.csdnimg.cn/img_convert/ffeb10e9ad1cbe82145cbf9fda858650.png)

- **非阻塞I/O**

⾮阻塞的 read 请求在数据未准备好的情况下⽴即返回，可以继续往下执⾏，此时应⽤程序不断轮询内核，直到数据准备好，内核将数据拷⻉到应⽤程序缓冲区， read 调⽤才可以获取到结果。

![非阻塞I/O](https://img-blog.csdnimg.cn/img_convert/68595da1c344b6d39838f0ef845da5eb.png)
...
![基于非阻塞的I/O多路复用](https://img-blog.csdnimg.cn/img_convert/628acf0ea1a0a87809c691d32f66e719.png)
...
![异步/IO](https://img-blog.csdnimg.cn/img_convert/3105dbd9435ee1e24d5b77ae4ca32faf.png)
...
![鸽宗](https://img-blog.csdnimg.cn/img_convert/6a21e757543e05cea758c1305e1099be.png)
...
![I/O多路复用](https://img-blog.csdnimg.cn/img_convert/0e3883e87d93d679a9804278471d1b28.png)
...
![epoll接口作用-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/6cd132d5c3c9e139b47c8f5d57ce635b.png)
...
[1].[这可能最全的操作系统面试题](https://blog.csdn.net/qq_36894974/article/details/115654242)

[2]. [操作系统常见面试题（2021最新版）](https://blog.csdn.net/weixin_45545542/article/details/117929487)
...
[7]. [IO多路复用与epoll原理探究](https://wendeng.github.io/2019/06/09/服务端编程/IO多路复用与epoll原理探究/)



# 计算机网络

> 此部分转载自https://mp.weixin.qq.com/s/yAlErlC09GnjaVvwUo3Acg
...
![三种网络体系结构](https://img-blog.csdnimg.cn/img_convert/905dc24eedefdde3556ef76eae7e8672.png)
...
![各层网络对应的网络协议](https://img-blog.csdnimg.cn/img_convert/1c550fb5eef34142c841c32885a3205e.png)
...
![数据在各层之间的传输](https://img-blog.csdnimg.cn/img_convert/dd7db46ba65dda50fc285c053a61d513.png)
...
![www.baidu.comliu到显示主页](https://img-blog.csdnimg.cn/img_convert/9edde19c6615c3f8357f9e3daca0304b.png)

> 各个过程都使用了哪些协议？

![www.baidu.comliu到显示主页过程使用的协议](https://img-blog.csdnimg.cn/img_convert/da6c6673606b39b556b1bbab7365231b.png)
...
![DNS解析流程](https://img-blog.csdnimg.cn/img_convert/ca1ddf9e8027eba7e05635febb12db19.png)
...
![域名服务器层级](https://img-blog.csdnimg.cn/img_convert/64330022533469d63040f8c10fbd25f3.png)
...
![常见端口和服务](https://img-blog.csdnimg.cn/img_convert/70eba6aeb42c294302454aaeae71db5a.png)
...
![常见HTTP状态码](https://img-blog.csdnimg.cn/img_convert/fbf86985dbb037f287b50a5d7ff0617a.png)
...
![HTTP请求方式1](https://img-blog.csdnimg.cn/img_convert/90cd5036750f3714efa23a1fce5687ad.png)
...
![Get和Post区别](https://img-blog.csdnimg.cn/img_convert/b703e0085db659b1758fff0ec1e8a5ca.png)
...
![HTTP请求的过程和原理](https://img-blog.csdnimg.cn/img_convert/fcabcb5cea7c252399fea2254caea7be.png)
...
![HTTP报文](https://img-blog.csdnimg.cn/img_convert/a8ab014c2b94172d523f1f0bcc78dc1b.png)
...
![URI和URL](https://img-blog.csdnimg.cn/img_convert/3ca2e596a437f51e350486aa406f55f3.png)
...
![HTTP协议变迁](https://img-blog.csdnimg.cn/img_convert/85b7cf658ec4c033525ac6a4fe71e0b8.png)
...
![HTTP和HTTPS](https://img-blog.csdnimg.cn/img_convert/ecf33222de4da2562b66f1e981d01819.png)
...
![https主要流程](https://img-blog.csdnimg.cn/img_convert/3401b17c85f3131624341d6d4381c556.png)

这里还画了一张更详尽的图：

![https工作流程详图](https://img-blog.csdnimg.cn/img_convert/94bdc0871613a0d0c06a1f90ce4b035c.png)
...
![证书签名和客户端校验-来源参考[2]](https://img-blog.csdnimg.cn/img_convert/951214eaaff9b3a0a49a2aa47eb69662.png)
...
![Cookie和Session](https://img-blog.csdnimg.cn/img_convert/0ebfc7dc4bd79fec907a0e3e1b09e4a3.png)
...
![Session和Cookie的关联](https://img-blog.csdnimg.cn/img_convert/9806bdc4d6d5712c5d563aa6feb2aa63.png)
...
![Session共享](https://img-blog.csdnimg.cn/img_convert/cac00bd235a173ee3ccd9ce8f8857f55.png)
...
![TCP三次握手示意图](https://img-blog.csdnimg.cn/img_convert/d26277a9f9a99eef9ee05e5900f7820e.png)
...
![大白话三次握手](https://img-blog.csdnimg.cn/img_convert/b3a93d67cd8bdd67d6c363634b20529d.png)
...
![无三次握手导致端口占用](https://img-blog.csdnimg.cn/img_convert/71c600a05e37078e401ddec79ca1fc45.png)

还有一种情况是已经失效的客户端发出的请求信息，由于某种原因传输到了服务器端，服务器端以为是客户端发出的有效请求，接收后产生错误。

![响应生效请求](https://img-blog.csdnimg.cn/img_convert/c55855fba3ce16eeb1bc9306e0849ae8.png)
...
![三次握手中创建的队列](https://img-blog.csdnimg.cn/img_convert/7e9b1c899ed8159c8c847721500831be.png)
...
![SYN攻击](https://img-blog.csdnimg.cn/img_convert/cc09508f334783d0eb2241cb9d94b5ca.png)
...
![TCP四次挥手](https://img-blog.csdnimg.cn/img_convert/7b1765c2b49e0da5bf65c95a11bd02aa.png)
...
![大白话四次挥手](https://img-blog.csdnimg.cn/img_convert/88bbcc539f9430964dc76ed1b69b2f73.png)
...
![2MSL恰好一个来回](https://img-blog.csdnimg.cn/img_convert/6874b1536b2a6138e227cb0d33a84f4f.png)
...
![TIME_WAIT状态的作用](https://img-blog.csdnimg.cn/img_convert/12c50f7f069fca0791dc65c600a038f2.png)
...
![TCP报文首部的格式](https://img-blog.csdnimg.cn/img_convert/8609205f4b4612104c9bfa0d4029a0f9.png)
...
![TCP保证可靠性的方法](https://img-blog.csdnimg.cn/img_convert/e865aec3227cc264a5c7f2d2013617e4.png)
...
![TCP校验和](https://img-blog.csdnimg.cn/img_convert/633de3e049590c8b182e763c6bbac9bd.png)

1. **序列号/确认应答**：TCP 给发送的每一个包进行编号，接收方会对收到的包进行应答，发送方就会知道接收方是否收到对应的包，如果发现没有收到，就会重发，这样就能保证数据的完整性。就像老师上课，会问一句，这一章听懂了吗？没听懂再讲一遍。

![序列号/确认应答](https://img-blog.csdnimg.cn/img_convert/cb887eb4f3147cff3900196d677e684d.png)
...
![滑动窗口简图](https://img-blog.csdnimg.cn/img_convert/626eab95405897c6c92ce8247b2f4453.png)

1. **最大消息长度**：在建立TCP连接的时候，双方约定一个最大的长度（MSS）作为发送的单位，重传的时候也是以这个单位来进行重传。理想的情况下是该长度的数据刚好不被网络层分块。

![最大消息长度](https://img-blog.csdnimg.cn/img_convert/4e6b183e10786d7d7fe3fc4dcbfa743c.png)

1. **超时重传：**超时重传是指发送出去的数据包到接收到确认包之间的时间，如果超过了这个时间会被认为是丢包了，需要重传。

![超时重传](https://img-blog.csdnimg.cn/img_convert/41fe1297ade5169ae7d62e138bee62be.png)
...
![拥塞控制简略示意图](https://img-blog.csdnimg.cn/img_convert/f60f478322c52cc5f844d0ece952f2de.png)
...
![TCP流量控制](https://img-blog.csdnimg.cn/img_convert/c7a4284c1a0a3f206ecd2cca65ab3a42.png)
...
![发送端滑动窗口](https://img-blog.csdnimg.cn/img_convert/2c5bb86d4a598833ea0b79c8b7701602.png)
...
![接收方滑动窗口](https://img-blog.csdnimg.cn/img_convert/2bbfef665b8223f6a8338bd0d050ea9f.png)
...
![小数据情况](https://img-blog.csdnimg.cn/img_convert/625cf6eec3b4d5b084409dfc7b7aa493.png)
...
![破解的水管-图片来源网络](https://img-blog.csdnimg.cn/img_convert/bbd58fc76e6dbb9a77b7420c6146353c.png)
...
![拥塞控制常用算法](https://img-blog.csdnimg.cn/img_convert/d0d90b7c0b01a0ab1fff433b9276afa3.png)
...
![慢启动算法](https://img-blog.csdnimg.cn/img_convert/3155fb98092879670307808355f796b3.png)

发包的个数是指数性的增⻓。

![慢启动呈指数型增长](https://img-blog.csdnimg.cn/img_convert/b7a52d3768261d5700d2ab5f0ff7bd4c.png)
...
![拥塞避免算法](https://img-blog.csdnimg.cn/img_convert/5d12fb3f664825fd271fab7d96937596.png)
...
![拥塞发生算法](https://img-blog.csdnimg.cn/img_convert/36fdd4f873d41443954887a09543193b.png)
...
![快速恢复算法](https://img-blog.csdnimg.cn/img_convert/9b463d06eadc70bb556f4906899c8842.png)

### 42.说说 TCP 的重传机制？

重传包括**超时重传、快速重传、带选择确认的重传（SACK）、重复 SACK 四种**。

![TCP重传分类](https://img-blog.csdnimg.cn/img_convert/275f29f14dbcce2edf58768e29916c86.png)
...
![RTT](https://img-blog.csdnimg.cn/img_convert/a512186c10d3bf39f6938fd6cc3aabe2.png)
...
![快速重传流程](https://img-blog.csdnimg.cn/img_convert/5f151faf50e8fac73a45eeca1c1828ad.png)
...
![SACK机制-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/fb0d86099592457c36dc7b955b6ea676.png)
...
![ACK丢包-来源参考[3]](https://img-blog.csdnimg.cn/img_convert/a0bf5f7c84fe566ec67cd18e391ce9a2.png)
...
![TCP 的粘包和拆包](https://img-blog.csdnimg.cn/img_convert/d9dd1b47472a960b843ec3619fa8774c.png)
...
![TCP和UDP区别](https://img-blog.csdnimg.cn/img_convert/26b50329084e730aaee7159bd6f34e2b.png)

可以这么形容：TCP是打电话，UDP是大喇叭。

![TCP和UDP比喻](https://img-blog.csdnimg.cn/img_convert/27d28110931d1b51833e065bc76904a5.png)
...
![QQ使用UDP](https://img-blog.csdnimg.cn/img_convert/b5b961703b56a871d097f81dc9166241.png)
...
![虚拟IP网](https://img-blog.csdnimg.cn/img_convert/1a556d8c61055198819bad8736259b54.png)
...
![IP地址分类](https://img-blog.csdnimg.cn/img_convert/3ba367122131390e679e1c48e243bcfd.png)
...
![IPV4不够解决办法](https://img-blog.csdnimg.cn/img_convert/64814d3cbc4e17dd7325b293836345ea.png)
...
![ARP 协议作用](https://img-blog.csdnimg.cn/img_convert/e7777c68f5e81ea832aa0e0d4dbd4088.png)
...
![IP地址和MAC地址](https://img-blog.csdnimg.cn/img_convert/f2a5ec0694f899e40b17aa47e3567a8f.png)
...
![ping百度](https://img-blog.csdnimg.cn/img_convert/247872a3b00298e942ee49eff7f23c52.png)
...
![主动攻击和被动攻击](https://img-blog.csdnimg.cn/img_convert/cde07485c3b5f1ef72def36307f93756.png)
...
![DNS劫持示意图](https://img-blog.csdnimg.cn/img_convert/16c1a501a787c81d535f36ec8af95615.png)
...
![CSRF典型例子](https://img-blog.csdnimg.cn/img_convert/be21dbf5368f592737954fd0ea91358e.png)
...
![请求太多服务器着不住](https://img-blog.csdnimg.cn/img_convert/5d5688bd1fe692968cd836356c829dd0.png)
...
![一个典型的XSS](https://img-blog.csdnimg.cn/img_convert/73d779000f5ee72237ba74bd42551639.png)
...
![对称加密](https://img-blog.csdnimg.cn/img_convert/f8f287ab547cf814d987b4effc37e5b1.png)

**非对称加密**：指的是加密和解密使用不同的密钥（即公钥和私钥）。公钥与私钥是成对存在的，如果用公钥对数据进行加密，只有对应的私钥才能解密。常见的非对称加密算法有 RSA。

![非对称加密](https://img-blog.csdnimg.cn/img_convert/e6b7d01f1316c6fafd5b12ab7ebf9d5f.png)
...
[1]. [2W字！梳理50道经典计算机网络面试题（收藏版）](https://mp.weixin.qq.com/s/TxgtGsU8MY-R96lNl5B6ig)
