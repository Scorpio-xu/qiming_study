...
> 本文为转载，作者：三分恶，[原文链接](https://mp.weixin.qq.com/s/SHkQ7LEOT0itt4bXMoDBPw)。
>
...
![Java集合主要关系](../_img/collection-1.png)
...
![ArrayList和LinkedList的数据结构](../_img/collection-2.png)
...
![ArrayList和LinkedList中间插入](../_img/collection-3.png)

![ArrayList和LinkedList中间删除](../_img/collection-4.png)
...
![ArrayList扩容](../_img/collection-5.png)
...
![ArrayList自定义序列化](../_img/collection-6.png)
...
![CopyOnWriteArrayList原理](../_img/collection-7.png)
...
![jdk1.8 hashmap数据结构示意图](../_img/collection-8.png)
...
![染色](../_img/collection-12.png)

### 11.HashMap的put流程知道吗？

先上个流程图吧:

![HashMap插入数据流程图](../_img/collection-13.png)
...
![HashMap查找流程图](../_img/collection-14.png)
...
![扰动函数示意图](../_img/collection-16.png)
...
![put中的扩容](../_img/collection-17.png)
...
![关于默认负载因子的注释](../_img/collection-24.png)
...
![扩容之后的索引计算](../_img/collection-25.png)

元素在重新计算hash之后，因为n变为2倍，那么n-1的mask范围在高位多1bit(红色)，因此新的index就会发生这样的变化：

![扩容位置变化](../_img/collection-26.png)

所以在扩容时，只需要看原来的hash值新增的那一位是0还是1就行了，是0的话索引没变，是1的化变成`原索引+oldCap`，看看如16扩容为32的示意图：

![扩容节点迁移示意图](../_img/collection-27.png)

扩容节点迁移主要逻辑：

![扩容主要逻辑](../_img/collection-28.png)
...
![自定义HashMap整体结构](../_img/collection-29.png)

完整代码：

![完整代码](../_img/collection-30.png)
...
![1.7ConcurrentHashMap示意图](../_img/collection-31.png)
...
![jdk1.7put流程](../_img/collection-38.png)
...
![ConcurrentHashmap jdk1.8put流程](../_img/collection-32.png)
...
![Entry节点](../_img/collection-33.png)

可以实现按插入的顺序或访问顺序排序。

![LinkedHashMap实现原理](../_img/collection-34.png)
...
![TreeMap](../_img/collection-35.png)
...
![HashSet套娃](../_img/collection-36.png)
...
[1]. 一个HashMap跟面试官扯了半个小时:https://blog.csdn.net/zhengwangzw/article/details/104889549/

[2]. 《大厂面试》—Java 集合连环30问:https://mp.weixin.qq.com/s/TaCWIXeHqbLFnSoJNoiEjA)

[3].《Java面经手册》

[4]. 《我想进大厂》之Java基础夺命连环16问  :(https://mp.weixin.qq.com/s?__biz=MzkzNTEwOTAxMA==&mid=2247485644&idx=1&sn=db46ab83196031d8f563585b72a7b511&chksm=c2b24031f5c5c927bd125e219d4c2c810254f49ddc28988591978d27fe10a07eac85247bf89e&token=570732653&lang=zh_CN#rd)

[5]. 数据结构之LinkedHashMap:https://www.jianshu.com/p/bbc8087bd9ce

[6].面经手册 · 第3篇《HashMap核心知识，扰动函数、负载因子、扩容链表拆分，深度学习》:https://bugstack.blog.csdn.net/article/details/107903915

[7]. 面试官：为什么 HashMap 的加载因子是0.75？:https://zhuanlan.zhihu.com/p/149687607

[8]. 面试旧敌之红黑树（直白介绍深入理解）:https://juejin.cn/post/6844903454767317005

[9]. Java TreeMap工作原理及实现  :https://yikun.github.io/2015/04/06/Java-TreeMap%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E5%8F%8A%E5%AE%9E%E7%8E%B0/

[10]. 手写HashMap，快手面试官直呼内行！:https://mp.weixin.qq.com/s/Z9yoRZW5itrtgbS-cj0bUg

[11].Java 8系列之重新认识HashMap:https://tech.meituan.com/2016/06/24/java-hashmap.html
